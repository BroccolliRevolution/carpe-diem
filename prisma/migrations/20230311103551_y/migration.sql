...
ALTER TABLE
    "Activity" DROP COLUMN "dailyId",
ADD COLUMN "goalId" INTEGER,
ADD
    COLUMN "max_grade" INTEGER NOT NULL DEFAULT 3;
...
ADD
    CONSTRAINT "Activity_goalId_fkey" FOREIGN KEY ("goalId") REFERENCES "Goal"("id") ON DELETE
...
ALTER TABLE "Goal"
ADD
    CONSTRAINT "Goal_childId_fkey" FOREIGN KEY ("childId") REFERENCES "Goal"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "Goal"
ADD
    CONSTRAINT "Goal_labelId_fkey" FOREIGN KEY ("labelId") REFERENCES "Label"("id") ON DELETE
SET NULL ON UPDATE CASCADE;